...
public class ExtRequestListDataClass {
    ...
    private final StringProperty ACCEPTANCE_STATUS;
    private final StringProperty ACCEPTANCE_REASON;
    private final StringProperty DESTINATION_FAC;
    private final StringProperty DESTINATION_FAC_CODE;
    private final StringProperty REQUEST_FAC;
    private final StringProperty REQUEST_FAC_CODE;


    public ExtRequestListDataClass(Integer id, String serialId, String sampleId, String surname, String othername, String age, String sex, String address,
                                   ...
                                   String fullName, String ageUnits, String fullAge, String accepStatus, String acceptReason, String destFac, String desFacCode,
                                   String reqFac, String reqFacCode){
        ...
        this.ACCEPTANCE_STATUS = new SimpleStringProperty(accepStatus);
        this.ACCEPTANCE_REASON = new SimpleStringProperty(acceptReason);
        this.DESTINATION_FAC = new SimpleStringProperty(destFac);
        this.DESTINATION_FAC_CODE = new SimpleStringProperty(desFacCode);
        this.REQUEST_FAC = new SimpleStringProperty(reqFac);
        this.REQUEST_FAC_CODE = new SimpleStringProperty(reqFacCode);
    }

    public String getACCEPTANCE_STATUS() {
        return ACCEPTANCE_STATUS.get();
    }

    public StringProperty ACCEPTANCE_STATUSProperty() {
        return ACCEPTANCE_STATUS;
    }

    public void setACCEPTANCE_STATUS(String ACCEPTANCE_STATUS) {
        this.ACCEPTANCE_STATUS.set(ACCEPTANCE_STATUS);
    }

    public String getACCEPTANCE_REASON() {
        return ACCEPTANCE_REASON.get();
    }

    public StringProperty ACCEPTANCE_REASONProperty() {
        return ACCEPTANCE_REASON;
    }

    public void setACCEPTANCE_REASON(String ACCEPTANCE_REASON) {
        this.ACCEPTANCE_REASON.set(ACCEPTANCE_REASON);
    }

    public String getDESTINATION_FAC() {
        return DESTINATION_FAC.get();
    }

    public StringProperty DESTINATION_FACProperty() {
        return DESTINATION_FAC;
    }

    public void setDESTINATION_FAC(String DESTINATION_FAC) {
        this.DESTINATION_FAC.set(DESTINATION_FAC);
    }

    public String getDESTINATION_FAC_CODE() {
        return DESTINATION_FAC_CODE.get();
    }

    public StringProperty DESTINATION_FAC_CODEProperty() {
        return DESTINATION_FAC_CODE;
    }

    public void setDESTINATION_FAC_CODE(String DESTINATION_FAC_CODE) {
        this.DESTINATION_FAC_CODE.set(DESTINATION_FAC_CODE);
    }

    public String getREQUEST_FAC() {
        return REQUEST_FAC.get();
    }

    public StringProperty REQUEST_FACProperty() {
        return REQUEST_FAC;
    }

    public void setREQUEST_FAC(String REQUEST_FAC) {
        this.REQUEST_FAC.set(REQUEST_FAC);
    }

    public String getREQUEST_FAC_CODE() {
        return REQUEST_FAC_CODE.get();
    }

    public StringProperty REQUEST_FAC_CODEProperty() {
        return REQUEST_FAC_CODE;
    }

    public void setREQUEST_FAC_CODE(String REQUEST_FAC_CODE) {
        this.REQUEST_FAC_CODE.set(REQUEST_FAC_CODE);
    }
