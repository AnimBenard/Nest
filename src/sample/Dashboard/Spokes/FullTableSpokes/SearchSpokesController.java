...
public class SearchSpokesController implements Initializable {
    @FXML
    ...
    RetrieveSpokesRequestListDataByDate retrieveSpokesRequestListDataByDate = new RetrieveSpokesRequestListDataByDate();
    ...
    public void addRequestToTable(String from, String to){
        ...
        retrieveSpokesRequestListDataByDate.retrieveRequestList(requestListData, from, to);
