package sample.Dashboard.Spokes;
...
import sample.Dashboard.Hub.*;
import sample.Dashboard.Spokes.FullTableSpokes.SearchSpokesController;
...
public class SpokesController implements Initializable {
    @FXML
    Label lb_name, lb_ID, lb_userNo, lb_reason, lb_error, lb_remove, lb_reset, lb_searchRequest;
    @FXML
    TextField tf_surname, tf_othernames, tf_age, tf_address, tf_distTBNo, tf_search;
    @FXML
    ComboBox<String> cb_refFacility, cb_typeOfSpecimen, cb_sampleAppearance, cb_month;
    @FXML
    Button btn_createRequest;
    @FXML
    ComboBox<String> cb_sex;
    @FXML
    ...
    public void addSpecAppearance(){
        ObservableList<String> specTypeData = FXCollections.observableArrayList();
        specTypeData.addAll("MUCOPURULENT", "BLOOD STAINED", "MUCO SALIVERY", "SALIVA");
    ...
    public void addRequestToTable(){
        ...
        retrieveRequestListData.retrieveRequestListSpokes(requestListData);
    ...
    public void openSearchRequestDialog(MouseEvent event){
        try{
            Image icon = new Image("/sample/images/etblogo.png");
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/sample/Dashboard/Spokes/FullTableSpokes/searchRequestSpokes.fxml"));
            DialogPane pane = loader.load();
            SearchSpokesController controller = loader.getController();
